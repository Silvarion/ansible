...
JVM_OPTS="$JVM_OPTS -Djna.tmpdir=/opt/cassandra_tmp"
JVM_OPTS="$JVM_OPTS -Djava.io.tmpdir=/opt/cassandra_tmp"
JVM_OPTS="$JVM_OPTS $MX4J_ADDRESS"
JVM_OPTS="$JVM_OPTS $MX4J_PORT"
JVM_OPTS="$JVM_OPTS $JVM_EXTRA_OPTS"

JVM_OPTS="$JVM_OPTS -Dcassandra.metricsReporterConfigFile=metrics-reporter-config.yaml"
